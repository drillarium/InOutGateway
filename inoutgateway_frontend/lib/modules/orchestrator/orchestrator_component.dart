...
class OrchestratorComponentWidget extends StatelessWidget {
  final String name;
  final String status;
  final void Function()? onTap; // Callback function when the component is tapped

  const OrchestratorComponentWidget({required this.name, required this.status, this.onTap, super.key});
